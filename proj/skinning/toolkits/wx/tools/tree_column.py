...
class tree_column(list_item):
    ...
    objParentTypes = wxClasses(wx.gizmos.TreeListCtrl)
    ...
    def createWidget(self, parentObj):
        obj = treeListCtrl.TreeColumnItem()
    ...
    def installDefaultEvent(self, evtHandler, evtObject, evtCallback):
        return wx.EVT_LIST_COL_CLICK(evtHandler, -1, evtCallback)
