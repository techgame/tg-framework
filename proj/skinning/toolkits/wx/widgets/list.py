...
class list(image_list.ImageListHandlerMixin, wxPyWidgetSkinElement):
    #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    elementGlobals.update({
        'ListItem': listCtrl.ListItem,
        'Item': listCtrl.ListItem,

        'ListColumnItem': listCtrl.ListColumnItem,
        'ListColumn': listCtrl.ListColumnItem,
        'Column': listCtrl.ListColumnItem,
        })
    ...
    def createWidget(self, parentObj):
        ...
        obj = listCtrl.ListCtrl(parentObj, **kwWX)
