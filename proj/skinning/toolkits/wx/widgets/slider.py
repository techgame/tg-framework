...
class slider(wxPyWidgetSkinElement):
    #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    def createWidget(self, parentObj):
        kwWX = self.getStyleSettingsCollectionWX(('style', 'pos', 'size', 'value', 'min', 'max'))
        kwWX.rename(point='pos', minValue='min', maxValue='max')
        obj = wx.Slider(parentObj, **kwWX)
        return obj
